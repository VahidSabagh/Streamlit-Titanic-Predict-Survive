...
name  = st.text_input("Input Passenger Name", 'Vahid Sabbagh')
sex = st.select_slider("Choose sex", ['male','female'])
age = st.slider("Choose age",0,100,90)
sibsp = st.slider("Choose siblings",0,10,5)
parch = st.slider("Choose parch",0,10,6)
ticket = st.text_input("Input Ticket Number", "8585")
fare = st.number_input("Input Fare Price", 0,1000,300)
